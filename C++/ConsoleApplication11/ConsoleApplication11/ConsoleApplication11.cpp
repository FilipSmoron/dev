...
private:
    int numerGrupy = 0;
    static const int limitMiejsc = 10;
    Student tab[limitMiejsc] = {};
    int ID = 0;
...
int main()
{
    ...
    student2->setROK(2);
    student3->setIMIE("Marcin");
    student3->setNAZWISKO("Tol");
    student3->setKIERUNEK("Informatyka stosowana");
    student3->setROK(1);

    Student tablica[3] = { *student1,*student2,*student3 };
